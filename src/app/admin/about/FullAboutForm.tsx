...
export default function FullAboutForm({ initialData }: { initialData: AboutData | null }) {
  ...
  useEffect(() => {
    console.log("Initial About Data:", initialData);
  }, [initialData]);
  ...
  async function handleSubmit(formData: FormData) {
    ...
    try {
      ...
      const errorMessage = error?.message || "Failed to update about page.";
  ...
  // Handle form submission from top button
  const handleTopSave = () => {
    if (formRef.current) {
  ...
  return (
    <form ref={formRef} action={handleSubmit} className="space-y-10">
      ...
      {/* TOP SAVE BUTTON */}
      {/* ═══════════════════════════════════════════════ */}
      <div className="sticky top-0 z-10 bg-white/95 backdrop-blur-sm -m-6 p-4 border-b border-[#E5E7EB] rounded-t-2xl flex justify-between items-center">
        <div>
          <h2 className="text-lg font-semibold text-[#110713]">Edit About Page</h2>
          <p className="text-sm text-[#66556B]">All changes are saved at once</p>
        </div>
      ...
      <div className="space-y-4 pt-4">
        ...
        <ImageField label="Hero Background Image" hint="Recommended size: 1920x1080px (16:9 aspect ratio) for best appearance." value={heroImageUrl} onChange={setHeroImageUrl} />
      </div>
      ...
      <div className="space-y-4">
        ...
        <ImageField label="Story Section Image" hint="Recommended size: 800x600px (4:3 aspect ratio) or square." value={storyImageUrl} onChange={setStoryImageUrl} />
      </div>
      ...
      <div className="space-y-4">
        ...
        <ImageField label="Home About Image" hint="Recommended size: 800x600px (4:3 aspect ratio) or square." value={imageUrl} onChange={setImageUrl} />
      </div>
      ...
      <div className="pt-4 border-t border-[#E5E7EB] flex justify-between items-center">
        <div>
          <p className="text-sm text-[#66556B]">All changes will be saved together</p>
        </div>

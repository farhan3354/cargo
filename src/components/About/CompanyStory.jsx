      ...
      <div className="max-w-[1240px] mx-auto px-5 grid lg:grid-cols-2 gap-12 items-start">
        <div>
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-gray-600 leading-relaxed mb-4 text-justify whitespace-pre-line">
              {storyContent}
            </p>
          </div>
        </div>

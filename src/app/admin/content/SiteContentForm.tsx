...
export function SiteContentForm({
  ...
  const fields = [
    ...
    // Contact Page Section (with Social Media)
    {
  ...
  const sectionMeta: Record<string, { title: string; description: string }> = {
    ...
    footer: { title: "🦶 Footer", description: "Text, contact info, and map shown in the website footer." },
    contact: { title: "📞 Contact Page", description: "Text, contact details, and social media links shown on the Contact Us page." },
  };

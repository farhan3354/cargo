...
const defaultServices = [
  {
    ...
    tags: ["Fast Delivery", "Secure Handling", "Live Tracking"],
  },
  {
    ...
    tags: ["Global Reach", "Customs Support", "Real-time Tracking"],
  },
  {
    title: "Air Freight",
    ...
    tags: ["Express Service", "Priority Handling", "Global Network"],
  },
  {
    title: "Sea Freight",
    ...
    tags: ["Cost Effective", "Bulk Shipping", "Port-to-Port"],
  },
  {
    ...
    tags: ["Pickup Service", "Final Delivery", "Peace of Mind"],
  },
  {
    ...
    tags: ["Documentation", "Customs Support", "Hassle-free"],
  },
];

export default function ServicesDetails({ dbServices = [] }) {
  ...
  const displayServices = dbServices.length > 0 
    ? dbServices.map(s => ({
        ...
        tags: s.tags || ["Fast Delivery", "Secure Handling", "Live Tracking"],
      }))
    : defaultServices;
        ...
        <div className="space-y-24">
          {displayServices.map((service, i) => (
            ...
            >
              ...
              {/* Text */}
              <div>
                <span className="text-[#1F2288] text-sm font-bold tracking-[3px] uppercase text-justify block">
                  Service {String(i + 1).padStart(2, '0')}
                </span>

                <h3 className="text-3xl md:text-4xl font-semibold text-[#110713] mt-3 mb-5 text-justify">
                  {service.title}
                </h3>

                <p className="text-gray-600 leading-relaxed text-lg text-justify break-words hyphens-auto">
                  {service.desc}
                </p>
                ...
                <div className="mt-6 flex gap-3 flex-wrap">
                  {service.tags && service.tags.map((tag, idx) => (
                    <span
                      key={idx}
                      className="px-4 py-2 bg-[#F3F4F6] rounded-full text-sm text-justify"
                    >
                      {tag}
                    </span>
                  ))}

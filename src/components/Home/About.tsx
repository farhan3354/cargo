        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-10">
            <h2 className="text-4xl lg:text-5xl font-heading font-normal text-[#110713]">
              Learn More About Manar Cargo
            </h2>
            <p className="text-lg text-[#66556B] leading-relaxed">
              Manar Cargo is dedicated to providing innovative shipping
              solutions tailored to meet the diverse needs of our customers
              across the globe.
            </p>
            <Link href="/about">
              <Button
                variant="outline"
                className="h-14 px-10 border-[#1F2288] text-[#1F2288] hover:bg-[#1F2288] hover:text-white font-bold rounded-md uppercase tracking-widest text-sm"
              >
                Read More
              </Button>
            </Link>
            ...
            <div className="flex mt-6 items-center gap-6 pt-12 border-t border-[#E5E7EB]">
              ...
              <div>
                ...
                <p className="text-[#1F2288] text-sm uppercase font-bold tracking-widest">
                  Founder
                </p>
              </div>
            </div>
